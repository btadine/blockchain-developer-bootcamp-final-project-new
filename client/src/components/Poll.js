    ...
    <div className="poll-container">
      <div>
        {props.hackIdsVotes[props.hackIdsVoted.indexOf(props.hackId)] ? (
          <Button
            className="buttonSelected voteButton"
            variant="outline-secondary"
            onClick={() => props.onVote(true, props.hackId)}
          >
            <span className="thumbs" role="img" aria-label="Thumbs up">
              &#128077;{' '}
            </span>
        ...
        false ? (
          ...
          >
            <span className="thumbs" role="img" aria-label="Thumbs down">
              &#128078;{' '}
            </span>
          ...
          <Button
            ...
            onClick={() => props.onVote(false, props.hackId)}
          >
            <span role="img" className="thumbs" aria-label="Thumbs down">
              &#128078;{' '}
            </span>
            <span> {props.downVotes}</span>
          </Button>
